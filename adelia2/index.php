...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] !== UPLOAD_ERR_NO_FILE) {
        ...
        if ($image === null) {
            // If upload failed, show a message or handle gracefully
    ...
    while ($thread = $threads->fetchArray(SQLITE3_ASSOC)):
        ...
        <div class="thread">
            ...
            try {
                ...
                $totalReplies = 0; // If error, fallback to 0
            }
            ...
            if ($totalReplies > 0) {
                ...
                if ($lastReply):
                    // The last reply number is the total number of replies, which equals the sequential numbering in reply.php

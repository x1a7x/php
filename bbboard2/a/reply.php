...
<div id="replyMode">
    <h2>Reply Mode</h2>
    <a href="index.php">Return to main board</a>
</div>
...
<div class="reply">
    ...
    <p class="postText"><?php echo nl2br(htmlspecialchars($parentPost["text"], ENT_QUOTES)); ?></p>
...
<div class="replies">
    ...
    <?php foreach ($replies as $reply) { ?>
        <div class="reply">
            ...
            <p class="postText"><?php echo nl2br(htmlspecialchars($reply["text"], ENT_QUOTES)); ?></p>
            <div style="clear: both;"></div>
        </div>
    <?php } ?>
</div>

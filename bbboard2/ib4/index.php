...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($nameLength > 14 || $textLength > 14000) {
        ...
        if (empty($errorMessage)) {
            ...
            $stmt = $db->prepare("INSERT INTO posts (name, text, image) VALUES (:name, :text, :image)");
...
$stmt = $db->prepare("SELECT id, name, text, image FROM posts ORDER BY id DESC LIMIT :limit OFFSET :offset");

...
define('TINYIB_LOGO', '<img src="va.jpg">'); 
define('TINYIB_THREADSPERPAGE', 10);  // Amount of threads shown per index page
define('TINYIB_PREVIEWREPLIES', 2);   // Amount of replies previewed on index pages
...
$tinyib_hidefieldsop = array('name', 'email', 'embed', 'password');       // Fields to hide when creating a new thread - e.g. array('name', 'email', 'subject', 'file', 'embed', 'password')
$tinyib_hidefields = array('name', 'email', 'subject', 'file', 'embed', 'password');         
...
define('TINYIB_MAXMESSAGE', 20000);    // Maximum message length  [0 to disable]
...
define('TINYIB_MAXWOP', 150);         // Width
define('TINYIB_MAXHOP', 150);         // Height

// Thumbnail size - reply
define('TINYIB_MAXW', 150);           // Width
define('TINYIB_MAXH', 150);           // Height

// Tripcode seed - Must not change once set!
define('TINYIB_TRIPSEED', '5463423434754687');        // Enter some random text  (used when generating secure tripcodes, hashing passwords and hashing IP addresses)
...
// Management panel
define('TINYIB_MANAGEKEY', 'am4');       // When set, the [Manage] link is hidden and the management panel may only be accessed via imgboard.php?manage=TINYIB_MANAGEKEY  ['' to disable]
...
define('TINYIB_ADMINPASS', 'a333');       // Administrator password
define('TINYIB_MODPASS', 'm333');         // Moderator password  ['' to disable]

...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header("Location: thread_{$thread_id}.html");
    exit;
}

// Serve static page if it exists
if (file_exists(__DIR__ . "/thread_{$thread_id}.html")) {
    header("Location: thread_{$thread_id}.html");
    exit;
}

// If static file is missing, generate it
